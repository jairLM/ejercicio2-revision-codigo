...
formulario.addEventListener('submit', function(e) {   //se añadio el evento en el submit y se colocó la funcion 
  ...
  if (nombre.length === 0) {
    name.classList.add("error")  //se puso el name
  }
  if (edad < 18 || edad > 120) {
    age.classList.add("error")  //se puse el age
  }
...
/* var spanNombre = document.createElement("span")    //se borra es bloque para que no se repita 
